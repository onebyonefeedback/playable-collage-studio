                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mt-12">
                    {benefits.map((benefit, index) => (
                        ...
                        >
                            ...
                            <div
                                className="absolute top-0 right-0 w-8 h-8 bg-background rotate-45 transform translate-x-4 -translate-y-4 opacity-0 group-hover:opacity-100 transition-opacity"/>
                        </div>
                    ))}
                </div>
            </div>
