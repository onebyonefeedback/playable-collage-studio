...
const translations = {
  ru: {
    ...
    benefit_5_title: 'Запоминаемость бренда',
    benefit_5_text: 'Интерактив создает эмоциональную связь с продуктом',
    benefit_6_title: 'Быстрая разработка',
    benefit_6_text: 'От идеи до готового playable за 5-7 дней',
  ...
  en: {
    ...
    benefit_5_title: 'Brand Memorability',
    benefit_5_text: 'Interactivity creates emotional connection with the product',
    benefit_6_title: 'Fast Development',
    benefit_6_text: 'From idea to ready playable in 5-7 days',
